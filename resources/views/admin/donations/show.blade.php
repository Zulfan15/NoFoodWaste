            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">{{ $donation->donor->name ?? 'N/A' }}</div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4 font-weight-bold">Email:</div>
                        <div class="col-md-8">{{ $donation->donor->email ?? 'N/A' }}</div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4 font-weight-bold">Phone:</div>
                        <div class="col-md-8">{{ $donation->donor->phone ?? 'N/A' }}</div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4 font-weight-bold">Role:</div>
                        <div class="col-md-8">{{ ucfirst($donation->donor->role ?? 'N/A') }}</div>
                    </div>
                    <a href="{{ route('admin.users.show', $donation->donor->user_id ?? 0) }}" class="btn btn-info btn-sm">
                        <i class="fas fa-user fa-sm text-white-50"></i> View Donor Profile
                    </a>
                </div>
            </div>
